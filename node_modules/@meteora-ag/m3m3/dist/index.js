...
var StakeForFee2 = class _StakeForFee {
  ...
  static async getAllStakedVaultByUser(connection, owner, opt) {
    ...
    const dynamicAmmProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _13 => _13.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
    const dynamicVaultProgram = createDynamicVaultProgram(
      connection,
    ...
    const chunkedAccountToFetch = _utils.chunks.call(void 0, 
    ...
    const poolAccountsToFetch = _utils.chunks.call(void 0, 
