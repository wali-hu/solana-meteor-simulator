...
class Fraction {
     ...
     */
    get asNumber() {
        if (this.denominator === constants_js_1.ZERO) {
            return this.numerator > constants_js_1.ZERO
                ? Number.POSITIVE_INFINITY
                : this.numerator < constants_js_1.ZERO
                    ? Number.NEGATIVE_INFINITY
                    : Number.NaN;
        }
        const result = parseFloat(this.numerator.toString()) /
     ...
     */
    isZero() {
        return this.numerator === constants_js_1.ZERO && this.denominator !== constants_js_1.ZERO;
    }
    /**
