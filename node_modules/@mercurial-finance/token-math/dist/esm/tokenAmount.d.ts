 ...
 * @returns
 */
export declare const parseAmountFromString: <Tk extends Token<Tk>>(token: Tk, uiAmount: string, decimalSeparator?: string, groupSeparator?: string) => bigint;
/**
 ...
 * @param value
 */
export declare function validateU64(value: bigint): void;
/**
 * Validates that a number falls within the range of u256.
 * @param value
 */
export declare function validateU256(value: bigint): void;
/**
...
export declare abstract class TokenAmount<T extends Token<T>> extends Fraction {
     ...
     */
    constructor(token: T, amount: BigintIsh, validate?: (value: bigint) => void);
    /**
