...
import { TOKEN_PROGRAM_ID, NATIVE_MINT, getMint, unpackMint } from '@solana/spl-token';
import { chunkedFetchMultipleVaultAccount, chunkedGetMultipleAccountInfos, deserializeAccount, getAssociatedTokenAccount, getOnchainTime, getOrCreateATAInstruction, getVaultPdas, unwrapSOLInstruction, wrapSOLInstruction, } from './utils';
...
const getAllVaultState = (tokensAddress, program, seedBaseKey) => __awaiter(void 0, void 0, void 0, function* () {
    const vaultAccountPdas = tokensAddress.map((tokenMint) => getVaultPdas(tokenMint, new PublicKey(program.programId), seedBaseKey));
    const vaultsPda = vaultAccountPdas.map(({ vaultPda }) => vaultPda);
    const vaultsState = (yield chunkedFetchMultipleVaultAccount(program, vaultsPda));
    ...
    const vaultLpAccounts = yield chunkedGetMultipleAccountInfos(program.provider.connection, [
        ...vaultLpMints,
        ...vaultMints,
    ]);
...
const getVaultState = (tokenAddress, program, seedBaseKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [vaultLpAccount, vaultAccount] = yield chunkedGetMultipleAccountInfos(program.provider.connection, [
        vaultState.lpMint,
        vaultState.tokenMint,
    ]);
    const vaultLpMint = unpackMint(vaultState.lpMint, vaultLpAccount, vaultLpAccount === null || vaultLpAccount === void 0 ? void 0 : vaultLpAccount.owner);
    const vaultMint = unpackMint(vaultState.tokenMint, vaultAccount, vaultAccount === null || vaultAccount === void 0 ? void 0 : vaultAccount.owner);
    return {
        vaultPda,
        vaultState,
        vaultLpMint,
...
export default class VaultImpl {
    ...
    getVaultSupply() {
        return __awaiter(this, void 0, void 0, function* () {
            const vaultLpMint = yield getMint(this.connection, this.vaultState.lpMint);
    ...
    createATAPreInstructions(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            let preInstructions = [];
            const [userToken, createUserTokenIx] = yield getOrCreateATAInstruction(this.tokenMint.address, owner, this.connection);
